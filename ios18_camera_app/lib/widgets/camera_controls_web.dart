...
class CameraControlsWeb extends StatefulWidget {
  final Function(double) onZoomChanged;
  final double zoomLevel;
  final double minZoomLevel;
  final double maxZoomLevel;

  const CameraControlsWeb({
    super.key,
  ...
  @override
  State<CameraControlsWeb> createState() => _CameraControlsWebState();
}

class _CameraControlsWebState extends State<CameraControlsWeb> {
  ...
  Future<void> _simulateCapture() async {
    try {
      ...
      debugPrint('Error simulating capture: $e');
    }
  }
  ...
  void _simulateCameraSwitch() {
    // Simulate camera switch with feedback
    HapticFeedback.selectionClick();
    
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        content: const Text('Switched to front camera'),
